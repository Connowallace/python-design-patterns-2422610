'''
The Strategy pattern separates algorithms (strategies to solve a problem) from the
class requiring different algortihms to solve similar problems. This keeps the code
